...
export default function TitularDependente() {
  const users = [
    { name: "Gabriel Silva", birthDate: "12/05/1990", cpf: "123.456.789-10", type: "Dependente" },
    { name: "Kaue Santos", birthDate: "20/07/1985", cpf: "234.567.890-12", type: "Dependente" },
    { name: "Gustavo Oliveira", birthDate: "15/01/2000", cpf: "345.678.901-23", type: "Dependente" },
    { name: "Ana Castela", birthDate: "10/03/1993", cpf: "456.789.012-34", type: "Dependente" },
  ];
    ...
    >
      ...
      <div className="relative w-full max-w-4xl bg-white shadow-md rounded-lg">
        <div className="p-4 border-b">
          <h2 className="text-2xl font-bold text-center">Lista de Usuários Dependentes</h2>
        </div>
